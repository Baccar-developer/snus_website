...
<br>
	<div class="form-container m-auto p-5 rounded-3 text-center" >
		...
		<label class="text-danger control-label me-auto">email or tel</label>
			<input type='text' placeholder="enter your email or tel°N" class="form-control py-2 mb-3" name="email_or_tel">
		<label class="text-danger control-label me-auto">password</label>
			...
			<div class="d-flex">
        		...
        		<p class="text-danger ms-auto"><input type="checkbox" class="form-check-input"> remeber me</p></div>
    		<br>
    		<button type="submit" class="btn btn-danger fs-3 rounded-5 px-4">Login</button>
    		</form>
    		<a class="fs-6 text-danger" href='{{url("Signin")}}'>don't have account?</a> 
    	</div>
	</div>
@endsection